...
object CalendarRepo {
    ...
    fun getAllCalendarAccount(): List<CalendarAccount> {
        ...
        userCursor.use { cursor ->
            ...
            while (cursor.moveToNext()) {
                ...
                val color = android.graphics.Color.valueOf(cursor.getInt(colorIndex))
    ...
    private fun addCalendarAccount(account: CalendarAccount): Boolean {
        ...
        val color =
            android.graphics.Color.valueOf(randomColor.red, randomColor.green, randomColor.blue)
    ...
    fun addEvent(account: CalendarAccount, event: CalendarEvent): Boolean {
        ...
        val values = ContentValues().apply {
            ...
            val startTime = event.startTime.toEpochMilli()
            put(CalendarContract.Events.DTSTART, startTime)
            val endTime = event.endTime.toEpochMilli()

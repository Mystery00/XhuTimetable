...
class NotifyAction(
    ...
    private val colorAccent = "#2196F3".toColorInt()
        ...
        val builder = notificationBuilder
            ...
            .setContentIntent(
                PendingIntent.getActivity(
                    appContext,
                    0,
                    NavActivity.jumpIntent(appContext, NavActivity.InitRoute.EXAM.name),
    ...
    suspend fun checkNotifyCourse() {
        ...
        val showDate = LocalDate.now().plus(1, DateTimeUnit.DAY)
